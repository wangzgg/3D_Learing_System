...
class Game1 {
    ...
    init() {
        ...
        this.scene.background = new THREE.Color(0x29294b);
        ...
        loader.load(`assets/fbx/people/FireFighter.fbx`, function (object) {
            ...
            tLoader.load(`assets/images/SimplePeople_FireFighter_Brown.png`, function (texture) {
                object.traverse(function (child) {
                    if (child.isMesh) {
    ...
    toggleAnimation() {
        sessionStorage.setItem('model',m);
        window.location.replace("http://localhost:2002/");
    }
